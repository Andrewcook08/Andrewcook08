...
**Local LLM Fine-tuning Pipeline** — Developed automated pipeline for custom LLM adaptation using MLX, LoRA adapters, and Ollama for secure local inference

**AI-Powered Knowledge Assistant** — Built an intelligent chatbot projected to save $1.95M annually using AWS Bedrock Agents and semantic search
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=github&logoColor=white)](https://andrewcook08.github.io/portfolio-website/)
